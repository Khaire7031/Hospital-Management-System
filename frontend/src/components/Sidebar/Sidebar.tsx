...
const links = [
    { name: 'Dashboard', url: "/dashboard", icon: <IconLayoutDashboard size={20} stroke={1.5} /> },
    { name: 'Doctors', url: "/doctors", icon: <IconUsers size={20} stroke={1.5} /> },
    { name: 'Patients', url: "/patients", icon: <IconUsers size={20} stroke={1.5} /> },
    { name: 'Appointments', url: "/appointments", icon: <IconCalendar size={20} stroke={1.5} /> },
    { name: 'Pharmacy', url: "/pharmacy", icon: <IconBuildingStore size={20} stroke={1.5} /> },
    { name: 'Reports', url: "/reports", icon: <IconFileReport size={20} stroke={1.5} /> },
